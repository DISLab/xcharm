...
namespace GraphLib {
	...
	template <class Graph, class Opts, GraphType graphType>
		class RMAT_Generator_Charm<Graph, Opts, VertexMapping::SingleVertex, graphType> :
			public CBase_RMAT_Generator_Charm <Graph, Opts, VertexMapping::SingleVertex, graphType>,
	...
	template <class Graph, class Opts, GraphType graphType, class CProxy_Aggregator>
		class RMAT_Generator_Tram<Graph, Opts, VertexMapping::SingleVertex, graphType, CProxy_Aggregator> :
			public CBase_RMAT_Generator_Tram <Graph, Opts, VertexMapping::SingleVertex, graphType, CProxy_Aggregator>,
				RMAT_Generator<Graph, Opts> {
				typedef typename Graph::Proxy CProxy_Graph;
				typedef typename Graph::Vertex Vertex;
				typedef typename Graph::Edge Edge;
