...
namespace GraphLib {
	...
	template <typename Graph, typename Opts, VertexMapping vertexMapping>
	class GraphGenerator<Graph, Opts, vertexMapping, GraphGeneratorType::Kronecker, TransportType::Charm> {
		typedef CProxy_Generator_Charm<Graph, Opts, vertexMapping, GraphGeneratorType::Kronecker> CProxy_Generator; 
	...
	class GraphGenerator<Graph, Opts, VertexMapping::SingleVertex, GraphGeneratorType::Kronecker, TransportType::Tram> {
		...
		typedef CProxy_Generator_Tram<Graph, Opts, VertexMapping::SingleVertex, GraphGeneratorType::Kronecker, CProxy_Aggregator> CProxy_Generator; 
		typedef CkIndex_Generator_Tram<Graph, Opts, VertexMapping::SingleVertex, GraphGeneratorType::Kronecker, CProxy_Aggregator> CkIndex_Generator;
		CProxy_Generator generator;
	...
	template <typename Graph, typename Opts>
	class GraphGenerator<Graph, Opts, VertexMapping::MultiVertex, GraphGeneratorType::Kronecker, TransportType::Tram> {
		typedef typename Graph::Proxy CProxy_Graph;
		typedef typename Graph::Vertex Vertex;
		typedef typename Graph::Edge Edge;
		typedef CProxy_ArrayMeshStreamer<std::pair<CmiUInt8, Edge>, long long, Vertex, SimpleMeshRouter> CProxy_Aggregator;
		typedef CProxy_Generator_Tram<Graph, Opts, VertexMapping::MultiVertex, GraphGeneratorType::Kronecker, CProxy_Aggregator> CProxy_Generator; 
		typedef CkIndex_Generator_Tram<Graph, Opts, VertexMapping::MultiVertex, GraphGeneratorType::Kronecker, CProxy_Aggregator> CkIndex_Generator;
		CProxy_Generator generator;
		CProxy_Aggregator aggregator;
		CProxy_Graph graphProxy;
		Graph g;
